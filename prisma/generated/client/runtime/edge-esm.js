...
function he(e, t) {
  let r = ul(t),
    ...
    i = new Proxy(e, {
      ...
      ownKeys(o) {
        let s = no(Reflect.ownKeys(o), r),
          a = no(Array.from(r.keys()), r);
...
C.inverseTangent = C.atan = function () {
  ...
  if (u.isFinite()) {
    ...
    if (h + 4 <= Pn) return (s = ce(g, h + 4, v).times(0.5)), (s.s = u.s), s;
  }
  for (
    g.precision = a = h + 10,
      g.rounding = 1,
...
function hl(e, t) {
  ...
  if (t.indexOf('_') > -1) {
    if (((t = t.replace(/(\d)_(?=\d)/g, '$1')), mo.test(t))) return Tn(e, t);
