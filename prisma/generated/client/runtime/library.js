...
var Mp = (e) => e,
  ...
  P = {
    ...
    util: {
      ...
      objId: function (e) {
        return (
          e.__id || Object.defineProperty(e, '__id', { value: ++$p }), e.__id
        );
      },
...
async function ka(e, t) {
  ...
  let o = await nt(),
    ...
    p;
  throw (
    (a && l ? (p = Aa(c)) : l ? (p = Ca(c)) : u ? (p = Sa(c)) : (p = Ia(c)),
...
async function md(engineType, config) {
  ...
  for (let e of searchLocations) {
    let t = Da(engineType, binaryTarget),
...
\`\`\``
      : '',
    c = (0,
    Bi.default)(`Hi Prisma Team! My Prisma Client just crashed. This is the report:
## Versions
...
async function Td(e, t) {
  let r = Ba['@prisma/engines-version'],
    ...
    async withRetry(t) {
      for (let r = 0; ; r++) {
        ...
        try {
          ...
          this.logEmitter.emit('warn', {
            message: `Attempt ${r + 1}/${Qa} failed for ${t.actionGerund}: ${i.message ?? '(unknown)'}`,
            timestamp: new Date(),
            target: '',
          });
          let o = await $a(r);
...
function Sd(e) {
  ...
  let r = Wa.default.toNamespacedPath(e),
    n = { exports: {} },
    i = 0;
  return (
    process.platform !== 'win32' &&
      (i =
        eo.default.constants.dlopen.RTLD_LAZY |
    ...
    async getCurrentBinaryTarget() {
      {
        ...
        if (!za.includes(t))
          throw new R(
            `Unknown ${ce('PRISMA_QUERY_ENGINE_LIBRARY')} ${ce(H(t))}. Possible binaryTargets: ${qe(za.join(', '))} or a path to the query engine library.
