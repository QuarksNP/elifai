...
export const PublishPost = () => {
  const { post, handleSubmit, openDialog, handleOpenDialog, isLoading } =
    useHandlePosts();
    ...
    <Card>
      ...
      <CardContent className="border-b border-border pt-6">
        <div>
          ...
          <h3>{post.title}</h3>
          <p className="text-sm text-muted-foreground line-clamp-2 max-w-96">
            {post.content.text}
          </p>
        </div>
        <time className="text-sm text-muted-foreground mt-4">
