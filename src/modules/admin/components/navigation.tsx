...
export const Navigation = () => {
    ...
    return (
        <nav className="flex flex-row fixed bottom-0 border-t border-muted z-10 bg-black w-full py-4 px-8 justify-evenly gap-2 left-0 md:relative md:border-none md:p-0 md:justify-normal md:bottom-auto md:w-auto">
